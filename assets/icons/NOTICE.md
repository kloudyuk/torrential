# Dashboard icon attribution

The Prowlarr, Plex, and Transmission marks are sourced from the
[Dashboard Icons](https://github.com/homarr-labs/dashboard-icons) project, licensed
under [Apache-2.0](licenses/Apache-2.0.txt). The Sonarr and Radarr marks are sourced
...
The Torrential mark is part of Torrential and is distributed under the repository's
MIT license.
